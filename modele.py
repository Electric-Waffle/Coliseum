...
class Model:
    ...
    def __init__(self, Player):
        ...
        self.annuaire_de_caracteristique_des_techniques = {
            ...
            "Lance de l'Eclair": [74, 36, 16, 11, 12, 
        ...
        self.annuaire_de_cout_des_sorts = {
            "Tir Arcanique": 3,
            "Faisceau Rapide": 5,
            "Faisceau Statique": 10,
            "Faisceau Electrique": 15,
            "Faisceau de l'Eclair": 20,
            "Faisceau Foudroyant": 25,
            "Faisceau de la Mort Blanche": 29,
            "Thermosphère Chaude": 5,
            "Thermosphère Brulante": 10,
            "Thermosphère Enflammée": 15,
            "Thermosphère de la Fournaise": 20,
            "Thermosphère Magmatique": 25,
            "Thermosphère Solaire": 29,
            "Pic Bleu": 5,
            "Pic Froid": 10,
            "Pic Givré": 15,
            "Pic Glacial": 20,
            ...
            "Pic Zéro": 29,
            "Création d'Argile": 5,
            "Création de Lapis": 10,
            "Création de Granite": 15,
            "Création Obsidienne": 20,
            "Création de la Montagne": 25,
            "Création Continentale": 29,
            "Explosion Légère": 5,
            "Explosion Renforcée": 10,
            "Explosion Lourde": 15,
            "Explosion Maitrisée": 20,
            "Explosion Fatale": 25,
            "Explosion de la Comète": 29,
            "Dance Volevie": 5,
            "Dance Siphoneuse": 10,
            "Dance Vampirique": 15,
            "Dance Parasite": 20,
            "Dance Destructrice": 25,
            "Dance Créatrice": 29,
            "Rafale": 12,
            "Avalanche": 25,
            "Libération Enflammée": 20,
            "Libération Fulgurante": 20,
            "Libération Glaciale": 20,
            "Libération Sanglante": 20,
            "Libération Holomélanocrate": 20,
            "Mirroir d'Eau": 25,
            "Brume de Sang": 25,
            "Explosion de Feu Sacré": 20,
            "Carrousel": 30,
            "Sonata Pitoyable": 5, 
            "Sonata Miséricordieuse": 10,
            "Sonata Empathique": 15,
            "Sonata Sincère": 20,
            "Sonata Bienveillante": 25,
            "Sonata Absolutrice": 29
        }
        ...
        self.alfred_liste_questions = [
            ...
            {
                "Question": ("Quel est ton taux d'esquive a ce moment précis ?"),
        ...
        self.annuaire_de_caracteristique_des_sorts_generaux_de_monstre = {
            # %touche, degat, %crit, degat crit, %element, description, message si rate, si touche, si touche crit, nombre tours, effet element
            "Flamme": [95, 3, 20, 5, 50, "L'ennemi fait apparaitre une flamme sur votre position....", 
            ...
            "Thermosphère Brulante": [88, 22, 20, 4, 18, "L'ennemi crée un tourbillon de flammes autour de vous, vous enveloppant dans une tempête de feu...",
                                      ...
                                      4, 7],
            "Thermosphère de la Fournaise": [84, 40, 20, 6, 20, "L'ennemi invoque le pouvoir de la fournaise dans la thermosphère, créant une incandescence infernale...",
                                                    ...
                                                    4, 6],
            "Thermosphère Magmatique": [82, 49, 20, 6, 22, "L'ennemi invoque la puissance du magma dans la thermosphère, créant des rivières de lave en fusion...",
                                                    ...
                                                    4, 5],
            "Thermosphère Solaire": [80, 56, 20, 8, 22, "L'ennemi canalise l'énergie solaire dans la thermosphère, créant une explosion de lumière et de chaleur...",
                                                    ...
                                                    5, 5],
            "Vents de l'Est": [0, 0, 0, 0, 0, "L'ennemi invoque les vents violents et pleins de sables de l'Est...", 
            ...
            "Faisceau Statique": [88, 22, 20, 4, 10, "L'ennemi charge son faisceau d'énergie statique, créant des étincelles d'électricité dans l'air...",
                                        ...
                                        2, 0],
            "Faisceau de l'Eclair": [84, 40, 16, 7, 14, "L'ennemi invoque la puissance de la foudre dans son faisceau, illuminant le ciel avec des éclairs dévastateurs...",
                                                    ...
                                                    2, 0],
            "Faisceau Foudroyant": [82, 49, 15, 7, 10, "L'ennemi libère un faisceau d'énergie foudroyante, déchirant le ciel avec un éclair dévastateur...",
                                                    ...
                                                    3, 0],
            "Faisceau de la Mort Blanche": [80, 56, 15, 11, 12, "L'ennemi canalise la puissance de l'éclair dans son faisceau, illuminant le champ de bataille avec une lueur mortelle...",
                                                    ...
                                                    3, 0],
            "Vents du Nord": [0, 0, 0, 0, 0, "L'ennemi invoque les vents glaciaux du Nord...", 
                             "...mais vous résistez aux températures givrantes .", 
                             "...et vous commencez a geler sur place !",
                             "...et vous vous mettez a ressentir de la chaleur et une torpeur mortelle !!", 0, 0],
            "Pic Froid": [88, 22, 20, 5, 18, "L'ennemi crée un pic de glace empreint d'une froideur intense, pointant menaçant vers vous...",
                                ...
                                3, 0],
            "Pic Glacial": [84, 40, 20, 5, 20, "L'ennemi canalise le pouvoir de l'hiver dans un pic de glace immense et imposant, pointant menaçant vers vous...",
                                ...
                                4, 0],
            "Pic Polaire": [82, 49, 20, 5, 22, "L'ennemi invoque un pic de glace chargé du froid polaire, pointant menaçant vers vous...",
                                "...mais son sort est dissipé par vous, le pic de glace se brisant avant de vous toucher.",
                                ...
                                4, 0],
            "Pic Zéro": [80, 56, 20, 5, 22, "L'ennemi libère un pic de glace d'un froid absolu, pointant menaçant vers vous...",
                                "...mais son sort est dissipé par vous, le pic de glace se brisant avant de vous toucher.",
                                ...
                                4, 0],
            "Création de Lapis": [88, 22, 10, 12, 12, "L'ennemi invoque des fragments de lapis-lazuli, créant une aura de gemmes étincelantes...",
                                    ...
                                    0, 65],
            "Création Obsidienne": [84, 40, 10, 16, 14, "L'ennemi invoque des flots d'obsidienne en fusion, créant un océan de lave en fusion...",
                                        ...
                                        0, 80],
            "Création de la Montagne": [82, 49, 10, 16, 16, "L'ennemi invoque le pouvoir des montagnes, élevant des sommets majestueux à partir de l'éther...",
                                            ...
                                            0, 90],
            "Création Continentale": [80, 56, 10, 20, 18, "L'ennemi invoque la puissance des continents, façonnant des terres immenses à partir de l'éther...",
                                            ...
                                            0, 100],
            "Vents de l'Ouest": [0, 0, 0, 0, 0, "L'ennemi invoque les vents magiques de l'Ouest...", 
                             "...mais vous résistez a ses effets .", 
                             "...et il vous lacère la peau !",
                             "...et il vous crible de blessures saignant abondemment !!", 0, 0],
            "Dance Siphoneuse": [88, 19, 15, 7, 27, "L'ennemi danse avec une fluidité hypnotique, drainant votre énergie vitale avec chaque mouvement...",
                                ...
                                0, 5],
            "Dance Parasite": [84, 37, 15, 8, 22, "L'ennemi danse avec une démarche insidieuse, implantant des parasites dans votre corps avec chaque mouvement...",
                                    ...
                                    0, 4],
            "Dance Destructrice": [82, 46, 15, 8, 22, "L'ennemi danse avec une férocité sauvage, déchirant votre corps avec chaque mouvement brutal...",
                                        ...
                                        0, 3],
            "Dance Créatrice": [80, 53, 15, 9, 17, "L'ennemi danse avec une grâce envoûtante, tissant des illusions et des mirages autour de vous...",
                                    ...
                                    0, 2],
            "Explosion Renforcée": [88, 22, 50, 4, 0, "L'ennemi accumule une puissance explosive plus grande, créant une détonation de force accrue...",
                                    ...
                                    0, 0],
            "Explosion Maitrisée": [84, 40, 50, 5, 0, "L'ennemi contrôle l'énergie explosive avec précision, créant une explosion focalisée et dirigée...",
                                        ...
                                        0, 0],
            "Explosion Fatale": [82, 49, 50, 5, 0, "L'ennemi libère une explosion d'une puissance destructrice, consumant tout sur son passage...",
                                    ...
                                    0, 0],
            "Explosion de la Comète": [80, 56, 50, 7, 0, "L'ennemi invoque une explosion colossale, déclenchant une détonation cosmique...",
                                            ...
                                            0, 0],
            "Missile Arcanique": [0, 0, 0, 0, 0, "L'ennemi invoque des projectiles arcaniques tourbillonnants, les lançant dans votre direction...",
                                ...
                                0, 0],
            "Flamme Avancée": [0, 0, 0, 0, 0, "L'ennemi canalise le feu ardent, créant une vague de flammes dévastatrices qui vous engloutissent...",
                                            ...
                                            0, 0],
            "Claquement de Foudre": [0, 0, 0, 0, 0, "L'ennemi invoque un éclair en claquant des doigts, le dirigeant droit vers vous avec un geste rapide...",
                                                ...
                                                0, 0],
            "Coup de Foudre": [0, 0, 0, 0, 0, "L'ennemi invoque une version supérieure du claquement de foudre, déclenchant une tempête électrique sur vous...",
                                                ...
                                                0, 0],
            "Rituel Canope": [0, 0, 0, 0, 0, "L'ennemi invoque le dieu égyptien Horus, maître de la foudre, à travers un rituel mystique, lançant un sort pour potentiellement vous paralyser...",
                                            ...
                                            0, 0],
            "Froideur d'Outretombe": [0, 0, 0, 0, 0, "L'ennemi canalise un froid glacial de l'outretombe, enveloppant tout dans un gel éternel...",
                                    ...
                                    0, 0],
            "Cercueil de Neige": [0, 0, 0, 0, 0, "L'ennemi invoque un cercueil de neige glaciale, l'enveloppant dans une tempête de poudreuse...",
                                    ...
                                    0, 0],
            "Gel": [0, 0, 0, 0, 0, "L'ennemi vous enveloppe dans un gel paralysant, figeant vos mouvements dans un étau de glace...",
                                    ...
                                    0, 0],
            "Giga Gel": [0, 0, 0, 0, 0, "L'ennemi libère une vague de gel dévastatrice, transformant tout en son passage en une toundra gelée...",
                                    ...
                                    0, 0],
            "Oméga Gelure": [0, 0, 0, 0, 0, "L'ennemi invoque l'essence même du froid, créant une glaciation totale dans son sillage...",
                                    ...
                                    0, 0],
            "Oméga Lapidation": [0, 0, 0, 0, 0, "L'ennemi invoque une pluie de pierres, transformant le champ de bataille en un chaos de roche...",
                                    ...
                                    0, 0],
            "Oméga Saignée": [0, 0, 0, 0, 0, "L'ennemi ouvre des plaies béantes dans le tissu de la réalité, provoquant un appel d'air et de force...",
                                    ...
                                    0, 0],
            "Mache": [0, 0, 0, 0, 0, "L'ennemi vous engloutit entièrement, vous mâchant avant de vous recracher...",
                        ...
                        0, 0],
            "Houken": [0, 0, 0, 0, 0, "L'ennemi libère un coup tranchant de houken, fendant l'air dans un éclair dévastateur...",
                                ...
                                0, 0],
            "Poing de Mana": [0, 0, 0, 0, 0, "L'ennemi canalise le pouvoir du mana dans son poing, déclenchant un coup explosif...",
                                    ...
                                    0, 0],
            "Tir Arcanique": [0, 0, 0, 0, 0, "L'ennemi tire une flèche chargée d'arcane, déchirant l'air avec une précision mortelle...",
                                    ...
                                    0, 0],
            "Explosion": [0, 0, 0, 0, 0, "L'ennemi déclenche une explosion dévastatrice, consumant tout sur son passage...",
                                ...
                                0, 0],
            "Point Vital": [0, 0, 0, 0, 0, "L'ennemi cible directement votre point vital, visant à frapper là où ça fait mal...",
                        ...
                        0, 0],
            "Son Rapide": [0, 0, 0, 0, 0, "L'ennemi libère un son rapide, déchiquetant l'air avec une rapidité effarante...",
                                    ...
                                    0, 0],
            "Bombe Arcanique": [0, 0, 0, 0, 0, "L'ennemi lance une bombe chargée d'arcane, détonant dans un éclair de magie dévastateur...",
        ...
        self.annuaire_de_caracteristique_des_sorts_speciaux_de_monstre = {
            ...
            "Soin": [5, 5, "L'ennemi lance un sort de soin !", 
                     "Le mana l'enveloppe et il reprend des points de vie !"],
            "Feu Regénérateur": [0, 0, "L'ennemi invoque un feu régénérateur pour restaurer ses points de vie.", 
                                "Le feu répare ses os brisés et guérit ses blessures."],
            "Réglages d'Usine": [0, 0, "L'ennemi tente de réinitialiser ses points de vie avec des réglages d'usine.", 
                                "Une énergie mystérieuse enveloppe l'ennemi, le restaurant à son état optimal."],
            "Regénération Basaltique": [0, 0, "L'ennemi utilise les roches environnantes pour se régénérer.", 
                                        "Les minéraux du basalte fusionnent avec le corps de l'ennemi, guérissant ses blessures."],
            "Carotte Magique": [0, 0, "L'ennemi mange une carotte magique pour restaurer ses points de vie.", 
                                "Les enzymes de la carotte se répandent dans le corps de l'ennemi, le soignant et le revitalisant."],
            "Soin Avancé": [0, 0, "L'ennemi enveloppe son corps de mana pour soigner ses blessures.", 
                            "Les blessures de l'ennemi cicatrisent à l'aide du mana invoqué."],
            "Engloutis": [0, 0, "L'ennemi engloutit un objet pour récupérer des points de vie.", 
                  "L'objet est absorbé par l'ennemi qui reprend des forces."],
            "Rejuvenation": [0, 0, "L'ennemi invoque un sort de réjuvenation pour se régénérer.", 
                            "Une lueur énergétique entoure l'ennemi, le revitalisant et réparant ses blessures."],
            "Tournicoti": [0, 0, "Tournicoti ! Tournicoti !\nL'ennemi tourne sur lui même et ses vêtements deviennent verts .", "Il reprend des points de vie !"],
            "Sonata": [0, 0, "description", "touche"],
            "Sonata Miséricordieuse": [0, 0, "L'ennemi utilise le sort Sonata Miséricordieuse !", 
                                       "Un son a peine apréciable se plaque contre sa peau et referme ses blessures."],
            "Sonata Sincère": [0, 0, "L'ennemi utilise le sort Sonata Sincère !", 
                               "Un chant cristallin inspire son esprit et revigore son corps."],
            "Sonata Bienveillante": [0, 0, "L'ennemi utilise le sort Sonata Bienveillante !", 
                                     "Une chorale glorieuse lui fait oublier les problèmes de sa situation et cicatrise ses blessures."],
            "Sonata Absolutrice": [0, 0, "L'ennemi utilise le sort Sonata Absolutrice !", 
                                   "Une mélodie féerique ramène son être tout entier a un état optimal."],
            "Oeuil Maudit": [0, 0, "L'ennemi se met a vous lancer un regard malveillant, empli de haine...", 
            ...
            "Possession du mana": [0, 0, "L'ennemi tente de s'approprier le flux de mana environnant...",
                                   "...mais il échappe a son controle",
                                   "...et il y arrive, le retournant contre vous."],
            "Ruée vers l'or": [0, 0, "L'ennemi vous stimule avec des effets sonores et lumineux, l'incitant à dépenser des pièces...", 
                               "...mais vous n'êtes pas très réceptif a ce genre de choses.", 
                               "...et fait naitre en vous les symptomes du Mal Jaune !"],
            "Confusion": [0, 0, "L'ennemi vous jette un sort de confusion...", 
                          "...mais il échoue.", 
        ...
        self.annuaire_de_caracteristique_des_techniques_generales_de_monstre = {
            # %touche, degat, %crit, degat crit, %element, description, message si rate, si touche, si touche crit, nombre tours, effet element
            "Poing de Feu": [0, 0, 0, 0, 0, "L'ennemi lance un poing enflammé vers vous, laissant derrière lui une traînée de flammes...",
                       ...
                       0, 0],
            "Souffle de Feu": [0, 0, 0, 0, 0, "L'ennemi aspire profondément, puis libère un souffle brûlant sur vous...",
                                    ...
                                    0, 0],
            "Jet de Magma": [0, 0, 0, 0, 0, "L'ennemi lance un jet de magma en fusion sur vous, la lave jaillissant avec force...",
                                    ...
                                    0, 0],
            "Ultralaser": [0, 0, 0, 0, 0, "L'ennemi charge une énergie intense dans ses yeux, puis libère un rayon laser destructeur sur sa cible...",
                                ...
                                0, 0],
            "Lame de Feu": [0, 0, 0, 0, 0, "L'ennemi matérialise une lame de feu dans sa main, puis la lance avec force sur sa cible...",
                                ...
                                0, 0],
            "Fleche Rouge": [0, 0, 0, 0, 0, "L'ennemi tire une flèche enflammée sur sa cible, la pointe rougeoyante filant à toute vitesse...",
                                    ...
                                    0, 0],
            "Laser Ultime": [0, 0, 0, 0, 0, "L'ennemi concentre toute son énergie dans un rayon laser colossal, puis le déchaîne sur sa cible...",
                                    ...
                                    0, 0],
            "Accrochage": [0, 0, 0, 0, 0, "L'ennemi se jette sur vous, s'accrochant fermement à votre tête et déclenchant des décharges électriques...",
                       ...
                       0, 0],
            "Pendule Etrange": [0, 0, 0, 0, 0, "L'ennemi active une étrange pendule, manipulant le temps autour de sa cible...",
                            ...
                            0, 0],
            "Morsure de Givre": [0, 0, 0, 0, 0, "L'ennemi plonge ses crocs glacés dans votre chair, drainant votre chaleur vitale...",
                      ...
                      0, 0],
            "Lame de Gel": [0, 0, 0, 0, 0, "L'ennemi charge avec sa lame de gel, prêt à vous geler et à drainer votre vitalité...",
                            ...
                            0, 0],
            "Fleche Bleue": [0, 0, 0, 0, 0, "L'ennemi décoche une flèche glaciale vers vous, prête à vous geler et à drainer votre vie...",
                                ...
                                0, 0],
            "Coup de pierre": [0, 0, 0, 0, 0, "L'ennemi assène un coup de poing solide sur vous, imprégné de l'énergie de la terre pour vous briser...",
                      ...
                      0, 0],
            "Eboulis": [0, 0, 0, 0, 0, "L'ennemi déclenche un éboulement de roches sur vous, prêt à vous submerger et vous briser...",
                        ...
                        0, 0],
            "Tomberoche": [0, 0, 0, 0, 0, "L'ennemi lève une énorme roche au-dessus de votre tête, prêt à l'abattre sur vous pour vous écraser...",
                            ...
                            0, 0],
            "Drain": [0, 0, 0, 0, 0, "L'ennemi utilise un sort de drain, aspirant votre énergie vitale pour se renforcer...",
                        ...
                        0, 0],
            "Lame Pourpre": [0, 0, 0, 0, 0, "L'ennemi dégaine une lame sombre imprégnée de puissance vitale, prêt à vous trancher et à drainer votre vie...",
                      ...
                      0, 0],
            "Ascension Runique": [0, 0, 0, 0, 0, "L'ennemi invoque des runes sanguines pour une ascension sinistre, drainant votre énergie vitale pour se renforcer...",
                        ...
                        0, 0],
            "Coup de Boule": [75, 2, 25, 5, 50, "L'ennemi s'approche de vous et envoie un gros coup de boule !", 
                              "Mais vous esquivez le coup !", 
                              "Et vous vous le prenez en pleine tronche !", 
                              "Et il vous envoie valser !", 0, 0],
            "Frappe Lourde": [0, 0, 0, 0, 0, "L'ennemi lève son arme lourde et s'apprête à vous frapper avec une force dévastatrice...",
                      ...
                      0, 0],
            "Attaque Légère": [0, 0, 0, 0, 0, "L'ennemi effectue une attaque rapide et légère, cherchant à vous désorienter...",
                                    "...mais sa frappe légère n'atteint pas sa cible, vous laissant indemne.",
                                    ...
                                    0, 0],
            "Impact": [0, 0, 0, 0, 0, "L'ennemi charge vers vous, prêt à vous asséner un coup puissant...",
                        ...
                        0, 0],
            "Coup de Griffe": [0, 0, 0, 0, 0, "L'ennemi vous attaque avec ses griffes acérées, cherchant à vous lacérer...",
                                    ...
                                    0, 0],
            "Morsure": [0, 0, 0, 0, 0, "L'ennemi tente de vous mordre avec ses crocs aiguisés, cherchant à vous infliger des blessures profondes...",
                            ...
                            0, 0],
            "Gros Coup de Boule": [0, 0, 0, 0, 0, "L'ennemi se prépare à vous asséner un coup de boule brutal...",
                                        ...
                                        0, 0],
            "Avale": [0, 0, 0, 0, 0, "L'ennemi ouvre grand sa gueule, prêt à vous engloutir...",
                        "...mais son attaque pour vous avaler rate sa cible, vous laissant indemne.",
                        ...
                        0, 0],
            "Attaque Lourde": [0, 0, 0, 0, 0, "L'ennemi prépare une attaque puissante, cherchant à vous submerger sous la force de son assaut...",
                                    ...
                                    0, 0],
            "Lame Courageuse": [0, 0, 0, 0, 0, "L'ennemi brandit son épée avec courage, prêt à vous affronter...",
                          ...
                          0, 0],
            "Attaque Titanesque": [0, 0, 0, 0, 0, "L'ennemi rassemble sa force pour une attaque titanesque, cherchant à vous anéantir...",
                                        ...
                                        0, 0],
            "Lame Ultime": [0, 0, 0, 0, 0, "L'ennemi déchaîne son attaque ultime, faisant briller son arme d'une lueur éclatante...",
                                    ...
                                    0, 0],
            "Lame Vaillante": [0, 0, 0, 0, 0, "L'ennemi attaque vaillamment avec son épée, cherchant à vous vaincre avec courage...",
                                    ...
                                    0, 0],
            "Corruption": [0, 0, 0, 0, 0, "L'ennemi vous regarde avec un regard sinistre, invoquant des forces sombres pour corrompre votre essence...",
        ...
        self.annuaire_de_caracteristique_des_techniques_speciales_de_monstre = {
            ...
            "Lèche-Blessure": [0, 0, 0, "L'ennemi lèche ses blessures...",
                              "...mais rien ne se passe.",
                              "...et elles commencent a se refermer !"],
            "Constructions du Zénith": [0, 0, 0, "L'ennemi tente de reconfigurer les parties de son corps...",
                                                "...mais il échoue.",
                                                "...et les organes les plus touchés sont alors protégés et soignés en priorité !"],
            "Gemme Rouge": [0, 0, 0, "L'ennemi utilise une gemme rouge pour se soigner...",
                                        "...mais rien ne se passe.",
                                        "...et elle se met a émettre une lumière apaisante, le soignant !"],
            "Medecine de Guerre": [0, 0, 0, "L'ennemi s'administre une médecine de guerre pour récupérer de ses blessures...",
                                                "...sans succès.",
                                                "...et il parvient a se rétablir juste assez pour terminer le combat !"],
            "Remede Divin": [0, 0, 0, "L'ennemi avale un remède divin pour restaurer sa santé...",
                                        "...en oubliant qu'il ne le digère pas.",
                                        "...et reprend beaucoup de vie !"],
            "Bouclier Ultime": [0, 0, 0, "L'ennemi érige un bouclier ultime pour se protéger et récupérer de ses blessures...",
                                            "...et tombe en avant sous le poids de l'objet.",
                                            "...et il enveloppe l'ennemi, le protégeant et le soignant."],
            "Poing Eclat": [0, 0, 0, "Le monstre vous assène un puissant coup de poing qui explose en une pluie d'éclats acérés...",
            ...
            "Coup du Foie": [0, 0, 0, "Le monstre vous frappe violemment au niveau du foie...",
            ...
            "Lame Dorée": [0, 0, 0, "Le monstre vous attaque avec une lame dorée étincelante...",
            ...
            "Etranglement": [8, 25, 3, "L'ennemi s'enroule autour de votre cou...", 
                             "...mais vous arrivez a vous débarrasser de son étreinte.", 
                             "...et vous étrangle sans ménagement.\nVous devenez muet pendant 2 tours !"],
            "Brulevent": [0, 0, 0, "Le monstre libère un souffle ardent qui consume tout l'oxygène de la salle...",
            ...
            "Roulé-Boulet": [0, 0, 0, "Le monstre se met en boule et vous percute avec une force dévastatrice, vous envoyant valser à travers la pièce...",
        ...
        #
        #
        #                           definir %touche, degat, %crit, degat crit, %element pour chaque attaque et sorts (ennemi)     | LORE
        #
        ...
        #faire Vaati personnage d'entretien                                                        |
        #
        #
        #                           cleanup                                                                               |
