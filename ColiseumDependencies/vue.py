...
class Vue:
    ...
    def AfficheResurrectionPianiste(self, musique):
        ...
        self.EntreePourContinuer()
        print("Vous remettez Zeroual dasn son fourreau, et vous préparez mentalement a noter les mouvements du Pianiste.")
        self.EntreePourContinuer()
        print("*Entend donc d'ou vient la simple mélodie que petit Noa n'a pas réussi à reproduire !*")
        dummies = input("Appuyez sur entree pour continuer.")
        dummies = input("Appuyez sur entree pour finir la mélodie des Coeurs Immolés..")
        clear_console()
