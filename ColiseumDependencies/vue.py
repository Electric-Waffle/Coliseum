...
class Vue:
    ...
    def AfficheResurrectionPianiste(self, musique):
        self.StopToutesMusiquesSiDejaLancee()
        print("*...*")
        self.EntreePourContinuer()
        print("*...encore...*")
        self.EntreePourContinuer()
        print("*...on me prend...encore....*")
        self.EntreePourContinuer()
        print("*..tout ce qu'il me reste....*")
        self.EntreePourContinuer()
        print("Le Pianiste rampe vers son piano, laissant derriere lui une trainée de sang.")
        self.EntreePourContinuer()
        print("*..Ha....*")
        self.EntreePourContinuer()
        print("*..Comme si il me restait quoi que ce soit a prendre....*")
        self.EntreePourContinuer()
        print("Le Pianiste se pose sur le siège.")
        self.EntreePourContinuer()
        print("*..Pour une fois....*")
        self.EntreePourContinuer()
        print("Vous vous approchez du Pianiste, bien déterminé a en finir.")
        self.EntreePourContinuer()
        print("*...au lieu de me faire prendre...*")
        self.EntreePourContinuer()
        print("*.....................laisse moi donner.*")
        self.EntreePourContinuer()
        print("Alors que Zeroual allait percer le corps du boss, celui ci rencontre une résistance sous la forme d'une bulle de mana.")
        self.EntreePourContinuer()
        print("Le Pianiste pose alors ses doigts sur les touches du piano, et prend une grande inspiration.")
        self.EntreePourContinuer()
        print("*Laisse moi te donner, la fin de ma musique.*")
        self.EntreePourContinuer()
        print("*Ma neuvième symphonie.*")
        self.EntreePourContinuer()
        print("*Regarde donc mes mains. Elles te diront ou aller... 3 temps en avance.*")
        self.EntreePourContinuer()
        print("*Fais de ton mieux, car a la fin de mon solo, tu prendra tout ce que tu n'a pas déja pris.*")
        self.EntreePourContinuer()
        print("Vous remettez Zeroual dans son fourreau, et vous préparez mentalement a noter les mouvements du Pianiste.")
        self.EntreePourContinuer()
        print("*Entend donc d'ou vient la simple mélodie que petit Noa n'a pas réussi à reproduire !*")
        dummies = input("Appuyez sur Entrée pour continuer.")
        dummies = input("Appuyez sur Entrée pour finir la mélodie des Coeurs Immolés..")
        clear_console()
        self.PlayMusic(musique + "boss_5_alt_outro", "noloop")
    ...
    def AfficheSymphonie(self, commentaire, commentaire_degat):
        self.AffichageUneLignePuisUnEntreePourContinuer(commentaire)
        self.AffichageUneLignePuisUnEntreePourContinuer(commentaire_degat)
