...
class Model:
    ...
    def __init__(self, Player):
        ...
        self.annuaire_de_caracteristique_des_techniques = {
            "Attaque Légère": [95, degat_attaque_legere, 10, 4, 0, "Vous frappez l'ennemi avec peu de force, mais beaucoup de précision...", 
            ...
            "Lance de l'Eclair": [74, 36, 10, 11, 10, 
            ...
            "Lance Foudroyante": [72, 45, 10, 11, 8, 
            ...
            "Lance de la Mort Blanche": [70, 52, 10, 13, 10,
        ...
        self.annuaire_de_caracteristique_des_sorts_generaux_de_monstre = {
            ...
            "Ré": [95, 20, 30, 15, 40, "L'ennemi fait vibrer la note *Ré*....", 
                       "...mais rien ne se passe .", 
                       "...et vous brulez !", 
                       "...et vous vous enflammez !!", 3, 8],
            "Mi": [95, 20, 30, 15, 20, "L'ennemi fait résonner la note *Mi*....", 
                       "...mais rien ne se passe .", 
                       "...et vous prenez froid !", 
                       "...et vous gelez sur place !!", 4, 8],
            "Fa": [95, 20, 30, 15, 10, "L'ennemi fait tonner la note *Fa*....", 
                       "...mais rien ne se passe .", 
                       "...et vous prenez la foudre !", 
                       "...et vous vous faites transpercer par un éclair !!", 3, 8],
            "Sol": [95, 20, 30, 15, 60, "L'ennemi fait hurler la note *Sol*....", 
                       "...mais rien ne se passe .", 
                       "...et des goutellettes de sang sortent par vos pores !", 
                       "...et vous crachez du sang !!", 3, 15],
            "La": [95, 20, 30, 20, 60, "L'ennemi fait résonner la note *La*....", 
                       "...mais rien ne se passe .", 
            ...
            "Thermosphère Brulante": [88, 10, 20, 4, 18, "L'ennemi crée un tourbillon de flammes autour de vous, vous enveloppant dans une tempête de feu...",
                                      ...
                                      4, 7],
            "Thermosphère de la Fournaise": [85, 15, 20, 6, 20, "L'ennemi invoque le pouvoir de la fournaise dans la thermosphère, créant une incandescence infernale...",
                                                    ...
                                                    4, 6],
            "Thermosphère Magmatique": [85, 20, 20, 6, 22, "L'ennemi invoque la puissance du magma dans la thermosphère, créant des rivières de lave en fusion...",
                                                    ...
                                                    4, 5],
            "Thermosphère Solaire": [85, 25, 20, 8, 22, "L'ennemi canalise l'énergie solaire dans la thermosphère, créant une explosion de lumière et de chaleur...",
            ...
            "Faisceau Statique": [88, 10, 20, 4, 10, "L'ennemi charge son faisceau d'énergie statique, créant des étincelles d'électricité dans l'air...",
                                        ...
                                        2, 0],
            "Faisceau de l'Eclair": [85, 15, 16, 7, 14, "L'ennemi invoque la puissance de la foudre dans son faisceau, illuminant le ciel avec des éclairs dévastateurs...",
                                                    ...
                                                    2, 0],
            "Faisceau Foudroyant": [85, 20, 15, 7, 10, "L'ennemi libère un faisceau d'énergie foudroyante, déchirant le ciel avec un éclair dévastateur...",
                                                    ...
                                                    3, 0],
            "Faisceau de la Mort Blanche": [85, 25, 15, 10, 12, "L'ennemi canalise la puissance de l'éclair dans son faisceau, illuminant le champ de bataille avec une lueur mortelle...",
            ...
            "Pic Froid": [88, 10, 20, 5, 18, "L'ennemi crée un pic de glace empreint d'une froideur intense, pointant menaçant vers vous...",
                                ...
                                3, 0],
            "Pic Glacial": [85, 15, 20, 5, 20, "L'ennemi canalise le pouvoir de l'hiver dans un pic de glace immense et imposant, pointant menaçant vers vous...",
                                ...
                                4, 0],
            "Pic Polaire": [85, 20, 20, 5, 22, "L'ennemi invoque un pic de glace chargé du froid polaire, pointant menaçant vers vous...",
                                "...mais son sort est dissipé par vous, le pic de glace se brisant avant de vous toucher.",
                                ...
                                4, 0],
            "Pic Zéro": [85, 25, 20, 5, 22, "L'ennemi libère un pic de glace d'un froid absolu, pointant menaçant vers vous...",
                                "...mais son sort est dissipé par vous, le pic de glace se brisant avant de vous toucher.",
            ...
            "Création de Lapis": [88, 10, 10, 8, 12, "L'ennemi invoque des fragments de lapis-lazuli, créant une aura de gemmes étincelantes...",
                                    ...
                                    0, 65],
            "Création Obsidienne": [85, 15, 10, 10, 14, "L'ennemi invoque des flots d'obsidienne en fusion, créant un océan de lave en fusion...",
                                        ...
                                        0, 80],
            "Création de la Montagne": [85, 20, 10, 10, 16, "L'ennemi invoque le pouvoir des montagnes, élevant des sommets majestueux à partir de l'éther...",
                                            ...
                                            0, 90],
            "Création Continentale": [85, 25, 10, 10, 18, "L'ennemi invoque la puissance des continents, façonnant des terres immenses à partir de l'éther...",
            ...
            "Dance Siphoneuse": [88, 10, 15, 7, 27, "L'ennemi danse avec une fluidité hypnotique, drainant votre énergie vitale avec chaque mouvement...",
                                ...
                                0, 5],
            "Dance Parasite": [85, 15, 35, 8, 22, "L'ennemi danse avec une démarche insidieuse, implantant des parasites dans votre corps avec chaque mouvement...",
                                    ...
                                    0, 4],
            "Dance Destructrice": [85, 20, 15, 8, 22, "L'ennemi danse avec une férocité sauvage, déchirant votre corps avec chaque mouvement brutal...",
                                        ...
                                        0, 3],
            "Dance Créatrice": [85, 25, 15, 9, 17, "L'ennemi danse avec une grâce envoûtante, tissant des illusions et des mirages autour de vous...",
            ...
            "Explosion Renforcée": [88, 10, 50, 4, 0, "L'ennemi accumule une puissance explosive plus grande, créant une détonation de force accrue...",
                                    ...
                                    0, 0],
            "Explosion Maitrisée": [85, 15, 50, 5, 0, "L'ennemi contrôle l'énergie explosive avec précision, créant une explosion focalisée et dirigée...",
                                        ...
                                        0, 0],
            "Explosion Fatale": [85, 20, 50, 5, 0, "L'ennemi libère une explosion d'une puissance destructrice, consumant tout sur son passage...",
                                    ...
                                    0, 0],
            "Explosion de la Comète": [85, 25, 50, 7, 0, "L'ennemi invoque une explosion colossale, déclenchant une détonation cosmique...",
            ...
            "Missile Arcanique": [90, 12, 30, 3, 0, "L'ennemi invoque des projectiles arcaniques tourbillonnants, les lançant dans votre direction...",
                                ...
                                0, 0],
            "Flamme Avancée": [85, 10, 27, 3, 15, "L'ennemi canalise le feu ardent, créant une vague de flammes dévastatrices qui vous engloutissent...",
            ...
            "Claquement de Foudre": [95, 6, 10, 4, 10, "L'ennemi invoque un éclair en claquant des doigts, le dirigeant droit vers vous avec un geste rapide...",
                                                ...
                                                2, 0],
            "Coup de Foudre": [85, 16, 20, 5, 15, "L'ennemi invoque une version supérieure du claquement de foudre, déclenchant une tempête électrique sur vous...",
            ...
            "Explosion": [95, 8, 30, 5, 0, "L'ennemi déclenche une explosion dévastatrice, consumant tout sur son passage...",
                                ...
                                0, 0],
            "Point Vital": [85, 20, 10, 10, 0, "L'ennemi cible directement votre point vital, visant à frapper là où ça fait mal...",
                        ...
                        0, 0],
            "Son Rapide": [85, 10, 30, 8, 0, "L'ennemi libère un son rapide, déchiquetant l'air avec une rapidité effarante...",
        ...
        self.annuaire_de_caracteristique_des_sorts_speciaux_de_monstre = {
            ...
            "Do": [50, 7, "L'ennemi fait mourir la note *Do*...", 
            ...
            "Oeuil Maudit": [70, 3, "L'ennemi se met a vous lancer un regard malveillant, empli de haine...", 
            ...
            "Possession du mana": [70, 4, "L'ennemi tente de s'approprier le flux de mana environnant...",
                                   "...mais il échappe a son controle",
                                   "...et il y arrive, le retournant contre vous."],
            "Ruée vers l'or": [70, 4, "L'ennemi vous stimule avec des effets sonores et lumineux, incitant à dépenser des pièces...", 
                               "...mais vous n'êtes pas très réceptif a ce genre de choses.", 
                               "...et fait naitre en vous les symptomes du Mal Jaune !"],
            "Confusion": [70, 3, "L'ennemi vous jette un sort de confusion...", 
                          "...mais il échoue.", 
                          "...et vos pensées deviennent aussi brouillées qu'un bruit de fond."],
            "Si": [70, 5, "L'ennemi frappe la note *Si* de son piano...", 
                          "...mais rien ne se passe.", 
        ...
        self.annuaire_de_caracteristique_des_techniques_generales_de_monstre = {
            ...
            "Fleche Rouge": [100, 3, 20, 15, 100, "L'ennemi tire une flèche enflammée sur sa cible, la pointe rougeoyante filant à toute vitesse...",
                                    ...
                                    4, 5],
            "Laser Ultime": [85, 15, 20, 7, 10, "L'ennemi concentre toute son énergie dans un rayon laser colossal, puis le déchaîne sur sa cible...",
                                    ...
                                    8, 5],
            "Accrochage": [85, 10, 30, 7, 10, "L'ennemi se jette sur vous, s'accrochant fermement à votre tête et déclenchant des décharges électriques...",
            ...
            "Frappe Lourde": [80, 10, 15, 8, 0, "L'ennemi lève son arme lourde et s'apprête à vous frapper avec une force dévastatrice...",
            ...
            "Coup de Griffe": [90, 12, 25, 4, 0, "L'ennemi vous attaque avec ses griffes acérées, cherchant à vous lacérer...",
                                    ...
                                    0, 0],
            "Morsure": [85, 8, 20, 4, 0, "L'ennemi tente de vous mordre avec ses crocs aiguisés, cherchant à vous infliger des blessures profondes...",
                            ...
                            0, 0],
            "Gros Coup de Boule": [85, 15, 20, 5, 0, "L'ennemi se prépare à vous asséner un coup de boule brutal...",
            ...
            "Attaque Titanesque": [90, 17, 10, 5, 0, "L'ennemi rassemble sa force pour une attaque titanesque, cherchant à vous anéantir...",
                                        ...
                                        0, 0],
            "Lame Ultime": [85, 20, 20, 6, 0, "L'ennemi déchaîne son attaque ultime, faisant briller son arme d'une lueur éclatante...",
        ...
        self.liste_de_commentaire_pour_catastrophe = [
            ...
            "...ce qui fait se poser une mouche sur le mix de fléchette bleue et rouge enclenchée dans l'arbalette cachée dans le mur et prête a etre déclenchée a la fin de cette attaque... ",
